...
ActiveRecord::Schema[7.0].define(version: 2023_05_18_182415) do
  ...
  create_table "cart_items", force: :cascade do |t|
    ...
    t.index ["product_id", "size"], name: "index_cart_items_on_product_id_and_size", unique: true
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.index ["product_id", "favoriter_id"], name: "index_favorites_on_product_id_and_favoriter_id", unique: true
  end
